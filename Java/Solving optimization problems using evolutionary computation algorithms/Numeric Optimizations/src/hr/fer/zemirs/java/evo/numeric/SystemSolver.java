...
private static Random rand = new Random();
	...
	private static void assertArguments(String[] args) {
		if(args.length != 3 && args.length != 5) {
			throw new RuntimeException("Program expects three arguments: algorithm selection (\"grad\" or \"newton\" ), max number of iterations (integer), path to file with defined linear system ");
		}
	}
